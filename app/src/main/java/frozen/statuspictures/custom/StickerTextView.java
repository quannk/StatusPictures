package frozen.statuspictures.custom;
...
import frozen.statuspictures.util.AutoResizeTextView;
...
public class StickerTextView extends StickerView {
    ...
    public void setFont(Typeface myFont){
        if(tv_main!=null)
            tv_main.setTypeface(myFont);
    }
    ...
    public void setTextSize(int textSize) {
        this.tv_main.setTextSize(textSize);
    }
}
